...
java "$JVM_ARGS" -classpath "$saxonb:$xmlresolver" -Dxml.catalog.files="$pathToCatalog" -Dxml.catalog.verbosity=2 net.sf.saxon.Transform -r:org.apache.xml.resolver.tools.CatalogResolver -x org.apache.xml.resolver.tools.ResolvingXMLReader -y org.apache.xml.resolver.tools.ResolvingXMLReader -ext:on -t -tree:linked -s ../data/pmc/Cancer/Cancer_2010_Apr_1_116\(7\)_1767-1775.nxml -xsl "$xslPubMed" > ../data/pmc/Cancer/Cancer_2010_Apr_1_116\(7\)_1767-1775.rdf

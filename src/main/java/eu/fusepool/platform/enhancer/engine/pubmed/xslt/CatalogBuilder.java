...
//			return ;
		...
		createCatalog() ;
		makeDTDDir() ;
		copyZipFile("archive-interchange-dtd-2.3.zip") ;
		copyZipFile("jats-archiving-dtd-1.0.zip") ;
		unZipIt(BASE_ZIP+"archive-interchange-dtd-2.3.zip", BASE_DTD) ;
		unZipIt(BASE_ZIP+"jats-archiving-dtd-1.0.zip", BASE_DTD) ;
